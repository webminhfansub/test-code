...
local v15 = v14:CreateWindow({
    Title = "Minhfansub hub [ Premium ]",-
    SubTitle = "By Minhfansub",-- tên bạn
    TabWidth = 160,
    Theme = "Dark",--màu
    Acrylic = false,
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=130112450110381";
...
v16.Home:AddButton({
    ...
    Callback = function()
        setclipboard("https://www.tiktok.com/@minhfansubhrfs");
    end
});
v16.Home:AddButton({
    Title = "Discord",
    Description = "Click(Copy)",
    Callback = function()
        setclipboard("https://discord.gg/k9QxqZcz2B");
    end
});
v16.Home:AddButton({
    Title = "Thông tin Admin:",
    Description = "script by Minhfansub.",
    Callback = function()
        setclipboard("https://webminhfansub.github.io/thongtincanhan/");
    end
});
